...
# Fields
FIELDS_ALIMENT = (" (NameAlim, NameStore, Url, DescriptionAlim," +
                  " NutritionGrade, IdCategory) ")
FIELDS_CATEGORY = " (NameCategory) "
FIELDS_FOODSAVE = " (IdAliment) "

# Fields to insert
FIELDS_INSERT_ALIMENT = (" %(NameAlim)s, %(NameStore)s, %(Url)s," +
                         " %(DescriptionAlim)s, %(NutritionGrade)s," +
                         " %(IdCategory)s")
